...
class Hero_Section extends Widget_Base {
    ...
    public function get_title() {
        return __('Hero Section ', 'nokri-elementor');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
         ...
         $this->add_control(
                'arrow_image',
                [
                    'label' => __('Arrow Image', 'nokri-elementor'),
                    'type' => \Elementor\Controls_Manager::MEDIA,
                    'default' => [
                        'url' => \Elementor\Utils::get_placeholder_image_src(),
                    ],
                     "description" => esc_html__('64 x 64', 'nokri-elementor'),
                ]
        );
        $this->add_control(
                'section_title',
    ...
    protected function render() {
        ...
        /* Arrow Image */
        $arrow_image1 = '';
        if (isset($arrow_image['url'])) {
      
            $img_thumb = $arrow_image['url'];
            $arrow_image1 = '<img class="img-responsive" src="' . esc_url($img_thumb) . '" alt="' . esc_attr__('image', 'nokri-elementor') . '">';
        }
        echo '<section class="main-section-slider style-3" ' . str_replace('\\', "", $bg_img) . '>
        <div class="container">
            <div class="row">
                        ...
                        <div class="search-filter-overflow-top-box">
                           <form class="form-inline"  method="get" action="' . get_the_permalink($nokri['sb_search_page']) . '">
                              ...
                              <div class="col-md-2 col-sm-6 col-xs-12 nopadding">
								...
								<button type="submit" class="btn n-btn-flat btn-search-submit">' . esc_html__('Search', 'nokri-elementor') . '<i class="fa fa-search"></i></button>
                                </div>
                              </div>
                            </form>
                        </div>
